...
#calcul indice de rareté des espèces
   ...
   b=unique(recensement_unique$Code_CT_SC_M)
 
  Indice_rarete_sp=NULL
  site_poisson<-matrix(0,27,length(recensement_unique$Code_CT_SC_M))

  for (n in 1:length(b)){
  site_poisson[,n]<-c(as.vector(recensement_unique$Code_Site[recensement_unique$Code_CT_SC_M==b[n]]),rep(0,27-length(recensement_unique$Code_Site[recensement_unique$Code_CT_SC_M==b[n]])))
  ...
  sites.etudies=c('T_S249','T_S250','T_S251','T_S252','T_S253','T_S254','T_S255','T_S256','T_S257','T_S258','T_S259','T_S260','T_S261','T_S262','T_S263','T_S264','T_S265','T_S266','T_S267','T_S268','T_S269','T_S270','T_S271','T_S272','T_S273','T_S274','T_S275')
    ...
    poissons_dans_station<-matrix(0,59,27)
    Indice_rarete_station<-NULL
    recensement_unique$Code_Site
   
   for (m in 1:27){             
    poissons_dans_station[,m]<-c(as.vector(recensement_unique$Code_CT_SC_M[recensement_unique$Code_Site==sites.etudies[m]]),rep(0,59-length(recensement_unique$Code_CT_SC_M[recensement_unique$Code_Site==sites.etudies[m]])))
...
combinaisons=matrix(0,99,3)
combinaisons[1,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[2,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[3,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[4,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[5,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[6,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[7,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[8,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[9,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[10,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[11,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[12,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[13,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[14,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[15,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[16,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[17,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[18,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[19,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[20,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[21,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[22,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[23,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[24,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[25,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[26,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[27,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[28,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[29,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[30,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[31,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[32,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[33,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[34,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[35,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[36,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[37,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[38,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[39,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[40,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[41,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[42,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[43,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[44,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[45,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[46,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[47,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[48,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[49,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[50,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[51,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[52,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[53,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[54,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[55,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[56,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[57,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[58,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[59,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[60,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[61,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[62,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[63,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[64,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[65,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[66,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[67,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[68,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[69,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[70,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[71,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[72,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[73,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[74,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[75,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[76,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[77,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[78,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[79,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[80,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[81,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[82,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[83,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[84,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[85,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[86,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[87,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[88,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[89,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[90,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[91,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[92,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[93,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[94,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[95,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[96,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[97,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[98,]<-sample(targeted.stations,3,replace=FALSE)
combinaisons[99,]<-sample(targeted.stations,3,replace=FALSE)
...
#calcul indice de rareté des espèces
  ...
  Indice_rarete_sp=NULL
  site_poisson<-matrix(0,24,length(recensement_unique$Code_CT_SC_M))

  for (n in 1:length(b)){
  site_poisson[,n]<-c(as.vector(recensement_unique$Code_Site[recensement_unique$Code_CT_SC_M==b[n]]),rep(0,24-length(recensement_unique$Code_Site[recensement_unique$Code_CT_SC_M==b[n]])))
  names(site_poisson[,n])=b[n]
  Indice_rarete_sp[n]<-2^(24-length(site_poisson[,n][site_poisson[,n]!=0]))
  names(Indice_rarete_sp)[n]=as.vector(b[n])     #Indice_rarete_sp est un vecteur qui contien l'indice de rareté pour chaque espèce
  } 
    
  #calcul indice de rareté des stations
  
  sites.etudies=targeted.stations[!targeted.stations%in%suppressed.station]
  
  
    poissons_dans_station<-matrix(0,59,24)
    Indice_rarete_station<-NULL
    recensement_unique$Code_Site
...
#30m
  ...
  b=unique(habitat_par_site_geo1_30m$Code_hab)
    ...
    Indice_rarete_geo1_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_30m$Code_Site[habitat_par_site_geo1_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_30m$Code_Site[habitat_par_site_geo1_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_30m_station<-matrix(0,500,24)
Indice_rarete_geo1_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_geo1_60m$Code_hab)
    ...
    Indice_rarete_geo1_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_60m$Code_Site[habitat_par_site_geo1_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_60m$Code_Site[habitat_par_site_geo1_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_60m_station<-matrix(0,500,24)
Indice_rarete_geo1_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_geo1_100m$Code_hab)
    ...
    Indice_rarete_geo1_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_100m$Code_Site[habitat_par_site_geo1_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_100m$Code_Site[habitat_par_site_geo1_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_100m_station<-matrix(0,500,24)
Indice_rarete_geo1_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_geo1_250m$Code_hab)
    ...
    Indice_rarete_geo1_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_250m$Code_Site[habitat_par_site_geo1_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_250m$Code_Site[habitat_par_site_geo1_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_250m_station<-matrix(0,500,24)
Indice_rarete_geo1_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_geo1_500m$Code_hab)
    ...
    Indice_rarete_geo1_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_500m$Code_Site[habitat_par_site_geo1_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_500m$Code_Site[habitat_par_site_geo1_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_500m_station<-matrix(0,500,24)
Indice_rarete_geo1_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_geo1_750m$Code_hab)
    ...
    Indice_rarete_geo1_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_750m$Code_Site[habitat_par_site_geo1_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_750m$Code_Site[habitat_par_site_geo1_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_750m_station<-matrix(0,500,24)
Indice_rarete_geo1_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_geo1_1000m$Code_hab)
    ...
    Indice_rarete_geo1_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_1000m$Code_Site[habitat_par_site_geo1_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_1000m$Code_Site[habitat_par_site_geo1_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_1000m_station<-matrix(0,500,24)
Indice_rarete_geo1_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_geo1_3000m$Code_hab)
    ...
    Indice_rarete_geo1_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_3000m$Code_Site[habitat_par_site_geo1_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_3000m$Code_Site[habitat_par_site_geo1_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_3000m_station<-matrix(0,500,24)
Indice_rarete_geo1_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_geo1_5000m$Code_hab)
    ...
    Indice_rarete_geo1_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_5000m$Code_Site[habitat_par_site_geo1_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_5000m$Code_Site[habitat_par_site_geo1_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_5000m_station<-matrix(0,500,24)
Indice_rarete_geo1_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_geo2_30m$Code_hab)
    ...
    Indice_rarete_geo2_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_30m$Code_Site[habitat_par_site_geo2_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_30m$Code_Site[habitat_par_site_geo2_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_30m_station<-matrix(0,500,24)
Indice_rarete_geo2_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_geo2_60m$Code_hab)
    ...
    Indice_rarete_geo2_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_60m$Code_Site[habitat_par_site_geo2_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_60m$Code_Site[habitat_par_site_geo2_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_60m_station<-matrix(0,500,24)
Indice_rarete_geo2_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_geo2_100m$Code_hab)
    ...
    Indice_rarete_geo2_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_100m$Code_Site[habitat_par_site_geo2_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_100m$Code_Site[habitat_par_site_geo2_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_100m_station<-matrix(0,500,24)
Indice_rarete_geo2_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_geo2_250m$Code_hab)
    ...
    Indice_rarete_geo2_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_250m$Code_Site[habitat_par_site_geo2_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_250m$Code_Site[habitat_par_site_geo2_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_250m_station<-matrix(0,500,24)
Indice_rarete_geo2_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_geo2_500m$Code_hab)
    ...
    Indice_rarete_geo2_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_500m$Code_Site[habitat_par_site_geo2_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_500m$Code_Site[habitat_par_site_geo2_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_500m_station<-matrix(0,500,24)
Indice_rarete_geo2_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_geo2_750m$Code_hab)
    ...
    Indice_rarete_geo2_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_750m$Code_Site[habitat_par_site_geo2_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_750m$Code_Site[habitat_par_site_geo2_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_750m_station<-matrix(0,500,24)
Indice_rarete_geo2_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_geo2_1000m$Code_hab)
    ...
    Indice_rarete_geo2_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_1000m$Code_Site[habitat_par_site_geo2_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_1000m$Code_Site[habitat_par_site_geo2_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_1000m_station<-matrix(0,500,24)
Indice_rarete_geo2_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_geo2_3000m$Code_hab)
    ...
    Indice_rarete_geo2_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_3000m$Code_Site[habitat_par_site_geo2_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_3000m$Code_Site[habitat_par_site_geo2_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_3000m_station<-matrix(0,500,24)
Indice_rarete_geo2_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_geo2_5000m$Code_hab)
    ...
    Indice_rarete_geo2_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo2_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo2_5000m$Code_Site[habitat_par_site_geo2_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo2_5000m$Code_Site[habitat_par_site_geo2_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo2_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo2_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo2_5000m_station<-matrix(0,500,24)
Indice_rarete_geo2_5000m_station<-NULL
...
#30m
  ...
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_30m$Code_Site[habitat_par_site_geo3_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_30m$Code_Site[habitat_par_site_geo3_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_30m_station<-matrix(0,500,24)
...
#60m
  ...
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_60m$Code_Site[habitat_par_site_geo3_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_60m$Code_Site[habitat_par_site_geo3_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_60m_station<-matrix(0,500,24)
...
#100m
  ...
  b=unique(habitat_par_site_geo3_100m$Code_hab)
    ...
    Indice_rarete_geo3_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_100m$Code_Site[habitat_par_site_geo3_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_100m$Code_Site[habitat_par_site_geo3_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_100m_station<-matrix(0,500,24)
Indice_rarete_geo3_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_geo3_250m$Code_hab)
    ...
    Indice_rarete_geo3_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_250m$Code_Site[habitat_par_site_geo3_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_250m$Code_Site[habitat_par_site_geo3_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_250m_station<-matrix(0,500,24)
Indice_rarete_geo3_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_geo3_500m$Code_hab)
    ...
    Indice_rarete_geo3_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_500m$Code_Site[habitat_par_site_geo3_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_500m$Code_Site[habitat_par_site_geo3_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_500m_station<-matrix(0,500,24)
Indice_rarete_geo3_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_geo3_750m$Code_hab)
    ...
    Indice_rarete_geo3_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_750m$Code_Site[habitat_par_site_geo3_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_750m$Code_Site[habitat_par_site_geo3_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_750m_station<-matrix(0,500,24)
Indice_rarete_geo3_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_geo3_1000m$Code_hab)
    ...
    Indice_rarete_geo3_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_1000m$Code_Site[habitat_par_site_geo3_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_1000m$Code_Site[habitat_par_site_geo3_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_1000m_station<-matrix(0,500,24)
Indice_rarete_geo3_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_geo3_3000m$Code_hab)
    ...
    Indice_rarete_geo3_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_3000m$Code_Site[habitat_par_site_geo3_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_3000m$Code_Site[habitat_par_site_geo3_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_3000m_station<-matrix(0,500,24)
Indice_rarete_geo3_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_geo3_5000m$Code_hab)
    ...
    Indice_rarete_geo3_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo3_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo3_5000m$Code_Site[habitat_par_site_geo3_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo3_5000m$Code_Site[habitat_par_site_geo3_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo3_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo3_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo3_5000m_station<-matrix(0,500,24)
Indice_rarete_geo3_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_bent1_30m$Code_hab)
    ...
    Indice_rarete_bent1_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_30m$Code_Site[habitat_par_site_bent1_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_30m$Code_Site[habitat_par_site_bent1_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_30m_station<-matrix(0,500,24)
Indice_rarete_bent1_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_bent1_60m$Code_hab)
    ...
    Indice_rarete_bent1_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_60m$Code_Site[habitat_par_site_bent1_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_60m$Code_Site[habitat_par_site_bent1_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_60m_station<-matrix(0,500,24)
Indice_rarete_bent1_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_bent1_100m$Code_hab)
    ...
    Indice_rarete_bent1_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_100m$Code_Site[habitat_par_site_bent1_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_100m$Code_Site[habitat_par_site_bent1_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_100m_station<-matrix(0,500,24)
Indice_rarete_bent1_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_bent1_250m$Code_hab)
    ...
    Indice_rarete_bent1_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_250m$Code_Site[habitat_par_site_bent1_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_250m$Code_Site[habitat_par_site_bent1_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_250m_station<-matrix(0,500,24)
Indice_rarete_bent1_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_bent1_500m$Code_hab)
    ...
    Indice_rarete_bent1_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_500m$Code_Site[habitat_par_site_bent1_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_500m$Code_Site[habitat_par_site_bent1_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_500m_station<-matrix(0,500,24)
Indice_rarete_bent1_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_bent1_750m$Code_hab)
    ...
    Indice_rarete_bent1_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_750m$Code_Site[habitat_par_site_bent1_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_750m$Code_Site[habitat_par_site_bent1_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_750m_station<-matrix(0,500,24)
Indice_rarete_bent1_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_bent1_1000m$Code_hab)
    ...
    Indice_rarete_bent1_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_1000m$Code_Site[habitat_par_site_bent1_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_1000m$Code_Site[habitat_par_site_bent1_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_1000m_station<-matrix(0,500,24)
Indice_rarete_bent1_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_bent1_3000m$Code_hab)
    ...
    Indice_rarete_bent1_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_3000m$Code_Site[habitat_par_site_bent1_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_3000m$Code_Site[habitat_par_site_bent1_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_3000m_station<-matrix(0,500,24)
Indice_rarete_bent1_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_bent1_5000m$Code_hab)
    ...
    Indice_rarete_bent1_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent1_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent1_5000m$Code_Site[habitat_par_site_bent1_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent1_5000m$Code_Site[habitat_par_site_bent1_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent1_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent1_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent1_5000m_station<-matrix(0,500,24)
Indice_rarete_bent1_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_bent2_30m$Code_hab)
    ...
    Indice_rarete_bent2_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_30m$Code_Site[habitat_par_site_bent2_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_30m$Code_Site[habitat_par_site_bent2_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_30m_station<-matrix(0,500,24)
Indice_rarete_bent2_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_bent2_60m$Code_hab)
    ...
    Indice_rarete_bent2_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_60m$Code_Site[habitat_par_site_bent2_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_60m$Code_Site[habitat_par_site_bent2_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_60m_station<-matrix(0,500,24)
Indice_rarete_bent2_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_bent2_100m$Code_hab)
    ...
    Indice_rarete_bent2_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_100m$Code_Site[habitat_par_site_bent2_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_100m$Code_Site[habitat_par_site_bent2_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_100m_station<-matrix(0,500,24)
Indice_rarete_bent2_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_bent2_250m$Code_hab)
    ...
    Indice_rarete_bent2_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_250m$Code_Site[habitat_par_site_bent2_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_250m$Code_Site[habitat_par_site_bent2_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_250m_station<-matrix(0,500,24)
Indice_rarete_bent2_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_bent2_500m$Code_hab)
    ...
    Indice_rarete_bent2_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_500m$Code_Site[habitat_par_site_bent2_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_500m$Code_Site[habitat_par_site_bent2_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_500m_station<-matrix(0,500,24)
Indice_rarete_bent2_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_bent2_750m$Code_hab)
    ...
    Indice_rarete_bent2_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_750m$Code_Site[habitat_par_site_bent2_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_750m$Code_Site[habitat_par_site_bent2_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_750m_station<-matrix(0,500,24)
Indice_rarete_bent2_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_bent2_1000m$Code_hab)
    ...
    Indice_rarete_bent2_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_1000m$Code_Site[habitat_par_site_bent2_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_1000m$Code_Site[habitat_par_site_bent2_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_1000m_station<-matrix(0,500,24)
Indice_rarete_bent2_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_bent2_3000m$Code_hab)
    ...
    Indice_rarete_bent2_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_3000m$Code_Site[habitat_par_site_bent2_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_3000m$Code_Site[habitat_par_site_bent2_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_3000m_station<-matrix(0,500,24)
Indice_rarete_bent2_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_bent2_5000m$Code_hab)
    ...
    Indice_rarete_bent2_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent2_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent2_5000m$Code_Site[habitat_par_site_bent2_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent2_5000m$Code_Site[habitat_par_site_bent2_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent2_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent2_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent2_5000m_station<-matrix(0,500,24)
Indice_rarete_bent2_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_bent3_30m$Code_hab)
    ...
    Indice_rarete_bent3_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_30m$Code_Site[habitat_par_site_bent3_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_30m$Code_Site[habitat_par_site_bent3_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_30m_station<-matrix(0,500,24)
Indice_rarete_bent3_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_bent3_60m$Code_hab)
    ...
    Indice_rarete_bent3_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_60m$Code_Site[habitat_par_site_bent3_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_60m$Code_Site[habitat_par_site_bent3_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_60m_station<-matrix(0,500,24)
Indice_rarete_bent3_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_bent3_100m$Code_hab)
    ...
    Indice_rarete_bent3_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_100m$Code_Site[habitat_par_site_bent3_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_100m$Code_Site[habitat_par_site_bent3_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_100m_station<-matrix(0,500,24)
Indice_rarete_bent3_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_bent3_250m$Code_hab)
    ...
    Indice_rarete_bent3_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_250m$Code_Site[habitat_par_site_bent3_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_250m$Code_Site[habitat_par_site_bent3_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_250m_station<-matrix(0,500,24)
Indice_rarete_bent3_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_bent3_500m$Code_hab)
    ...
    Indice_rarete_bent3_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_500m$Code_Site[habitat_par_site_bent3_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_500m$Code_Site[habitat_par_site_bent3_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_500m_station<-matrix(0,500,24)
Indice_rarete_bent3_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_bent3_750m$Code_hab)
    ...
    Indice_rarete_bent3_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_750m$Code_Site[habitat_par_site_bent3_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_750m$Code_Site[habitat_par_site_bent3_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_750m_station<-matrix(0,500,24)
Indice_rarete_bent3_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_bent3_1000m$Code_hab)
    ...
    Indice_rarete_bent3_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_1000m$Code_Site[habitat_par_site_bent3_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_1000m$Code_Site[habitat_par_site_bent3_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_1000m_station<-matrix(0,500,24)
Indice_rarete_bent3_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_bent3_3000m$Code_hab)
    ...
    Indice_rarete_bent3_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_3000m$Code_Site[habitat_par_site_bent3_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_3000m$Code_Site[habitat_par_site_bent3_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_3000m_station<-matrix(0,500,24)
Indice_rarete_bent3_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_bent3_5000m$Code_hab)
    ...
    Indice_rarete_bent3_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_bent3_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_bent3_5000m$Code_Site[habitat_par_site_bent3_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_bent3_5000m$Code_Site[habitat_par_site_bent3_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_bent3_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_bent3_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

bent3_5000m_station<-matrix(0,500,24)
Indice_rarete_bent3_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_geo1_geo2_30m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_30m$Code_Site[habitat_par_site_geo1_geo2_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_30m$Code_Site[habitat_par_site_geo1_geo2_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_30m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_geo1_geo2_60m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_60m$Code_Site[habitat_par_site_geo1_geo2_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_60m$Code_Site[habitat_par_site_geo1_geo2_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_60m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_geo1_geo2_100m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_100m$Code_Site[habitat_par_site_geo1_geo2_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_100m$Code_Site[habitat_par_site_geo1_geo2_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_100m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_geo1_geo2_250m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_250m$Code_Site[habitat_par_site_geo1_geo2_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_250m$Code_Site[habitat_par_site_geo1_geo2_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_250m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_geo1_geo2_500m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_500m$Code_Site[habitat_par_site_geo1_geo2_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_500m$Code_Site[habitat_par_site_geo1_geo2_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_500m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_geo1_geo2_750m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_750m$Code_Site[habitat_par_site_geo1_geo2_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_750m$Code_Site[habitat_par_site_geo1_geo2_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_750m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_geo1_geo2_1000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_1000m$Code_Site[habitat_par_site_geo1_geo2_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_1000m$Code_Site[habitat_par_site_geo1_geo2_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_1000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_geo1_geo2_3000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_3000m$Code_Site[habitat_par_site_geo1_geo2_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_3000m$Code_Site[habitat_par_site_geo1_geo2_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_3000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_geo1_geo2_5000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_5000m$Code_Site[habitat_par_site_geo1_geo2_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_5000m$Code_Site[habitat_par_site_geo1_geo2_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_5000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_30m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_30m$Code_Site[habitat_par_site_geo1_geo2_geo3_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_30m$Code_Site[habitat_par_site_geo1_geo2_geo3_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_30m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_60m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_60m$Code_Site[habitat_par_site_geo1_geo2_geo3_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_60m$Code_Site[habitat_par_site_geo1_geo2_geo3_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_60m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_100m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_100m$Code_Site[habitat_par_site_geo1_geo2_geo3_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_100m$Code_Site[habitat_par_site_geo1_geo2_geo3_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_100m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_250m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_250m$Code_Site[habitat_par_site_geo1_geo2_geo3_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_250m$Code_Site[habitat_par_site_geo1_geo2_geo3_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_250m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_500m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_500m$Code_Site[habitat_par_site_geo1_geo2_geo3_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_500m$Code_Site[habitat_par_site_geo1_geo2_geo3_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_500m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_750m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_750m$Code_Site[habitat_par_site_geo1_geo2_geo3_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_750m$Code_Site[habitat_par_site_geo1_geo2_geo3_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_750m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_1000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_1000m$Code_Site[habitat_par_site_geo1_geo2_geo3_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_1000m$Code_Site[habitat_par_site_geo1_geo2_geo3_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_1000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_3000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_3000m$Code_Site[habitat_par_site_geo1_geo2_geo3_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_3000m$Code_Site[habitat_par_site_geo1_geo2_geo3_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_3000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_geo1_geo2_geo3_5000m$Code_hab)
    ...
    Indice_rarete_geo1_geo2_geo3_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_geo1_geo2_geo3_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_5000m$Code_Site[habitat_par_site_geo1_geo2_geo3_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_geo1_geo2_geo3_5000m$Code_Site[habitat_par_site_geo1_geo2_geo3_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_geo1_geo2_geo3_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_geo1_geo2_geo3_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

geo1_geo2_geo3_5000m_station<-matrix(0,500,24)
Indice_rarete_geo1_geo2_geo3_5000m_station<-NULL
    for (m in 1:24){
  geo1_geo2_geo3_5000m_station[,m]<-c(as.vector(habitat_par_site_geo1_geo2_geo3_5000m$Code_hab[habitat_par_site_geo1_geo2_geo3_5000m$Code_Site==sites.etudies[m]]),rep(0,500-length(habitat_par_site_geo1_geo2_geo3_5000m$Code_hab[habitat_par_site_geo1_geo2_geo3_5000m$Code_Site==sites.etudies[m]])))
  Indice_rarete_geo1_geo2_geo3_5000m_station[m]=sum(Indice_rarete_geo1_geo2_geo3_5000m[names(Indice_rarete_geo1_geo2_geo3_5000m)%in%geo1_geo2_geo3_5000m_station[,m]])
...
#30m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_30m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_30m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_60m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_60m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_100m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_100m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_250m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_250m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_500m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_500m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_750m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_750m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_1000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_1000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_3000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_3000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_5000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_5000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_30m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_30m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_60m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_60m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_100m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_100m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_250m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_250m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_500m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_500m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_750m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_750m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_1000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_3000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_5000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_5000m_station<-NULL
...
#30m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_30m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_30m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_30m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_30m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_30m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_30m_station<-NULL
...
#60m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_60m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_60m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_60m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_60m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_60m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_60m_station<-NULL
...
#100m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_100m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_100m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_100m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_100m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_100m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_100m_station<-NULL
...
#250m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_250m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_250m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_250m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_250m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_250m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_250m_station<-NULL
...
#500m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_500m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_500m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_500m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_500m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_500m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_500m_station<-NULL
...
#750m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_750m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_750m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_750m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_750m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_750m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_750m_station<-NULL
...
#1000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_1000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_1000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_1000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_1000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_1000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_1000m_station<-NULL
...
#3000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_3000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_3000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_3000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_3000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_3000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_3000m_station<-NULL
...
#5000m
  ...
  b=unique(habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_hab)
    ...
    Indice_rarete_g1_g2_g3_b1_b2_b3_5000m=NULL
  site_habitat<-matrix(0,24,length(habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_hab))

    
    for (n in 1:length(b)){ 
    site_habitat[,n]<-c(as.vector(habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_hab==b[n]]),rep(0,24-length(habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_Site[habitat_par_site_g1_g2_g3_b1_b2_b3_5000m$Code_hab==b[n]])))
    names(site_habitat[,n])=b[n]
    Indice_rarete_g1_g2_g3_b1_b2_b3_5000m[n]<-2^(24-length(site_habitat[,n][site_habitat[,n]!=0]))
    names(Indice_rarete_g1_g2_g3_b1_b2_b3_5000m)[n]=as.vector(b[n])
    }
    
#calcul indice de rareté des stations    

g1_g2_g3_b1_b2_b3_5000m_station<-matrix(0,500,24)
Indice_rarete_g1_g2_g3_b1_b2_b3_5000m_station<-NULL
