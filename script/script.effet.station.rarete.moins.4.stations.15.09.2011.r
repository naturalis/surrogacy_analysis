...
combinaisons[1,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[2,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[3,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[4,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[5,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[6,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[7,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[8,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[9,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[10,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[11,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[12,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[13,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[14,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[15,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[16,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[17,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[18,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[19,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[20,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[21,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[22,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[23,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[24,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[25,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[26,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[27,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[28,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[29,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[30,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[31,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[32,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[33,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[34,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[35,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[36,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[37,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[38,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[39,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[40,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[41,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[42,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[43,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[44,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[45,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[46,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[47,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[48,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[49,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[50,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[51,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[52,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[53,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[54,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[55,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[56,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[57,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[58,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[59,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[60,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[61,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[62,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[63,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[64,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[65,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[66,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[67,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[68,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[69,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[70,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[71,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[72,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[73,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[74,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[75,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[76,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[77,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[78,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[79,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[80,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[81,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[82,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[83,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[84,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[85,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[86,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[87,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[88,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[89,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[90,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[91,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[92,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[93,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[94,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[95,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[96,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[97,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[98,]<-sample(sites.etudies,4,replace=FALSE)
combinaisons[99,]<-sample(sites.etudies,4,replace=FALSE)
...
#calcul indice de rareté des espèces
  ...
  Indice_rarete_sp=NULL
  site_poisson<-matrix(0,23,length(recensement_unique$Code_poisson))

  for (n in 1:length(b)){
  site_poisson[,n]<-c(as.vector(recensement_unique$Code_Site[recensement_unique$Code_poisson==b[n]]),rep(0,23-length(recensement_unique$Code_Site[recensement_unique$Code_poisson==b[n]])))
  names(site_poisson[,n])=b[n]
  ...
  sites.etudies<-targeted.stations[!targeted.stations%in%suppressed.station]
    ...
    poissons_dans_station<-matrix(0,335,23)
    Indice_rarete_station<-NULL
    recensement_unique$Code_Site
