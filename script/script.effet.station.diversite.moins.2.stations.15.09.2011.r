...
setwd(repertoire)
 setwd(input)
 requette.abondance.poissons<-read.csv2('abondance_taxo_IRD.csv')
input.shannon.abondance<-xtabs(formula=requette.abondance.poissons$Abondance~requette.abondance.poissons$site+requette.abondance.poissons$poissons,requette.abondance.poissons)
...
#Diversité de poisson incluse dans les sites selectionnés (aléatoirement et selon diversité de poisson)
 source('script.diversite.shannon.selectionnee.r')
...
#création d'un tableau de présence absence
tablo_pres_abs<-table(as.character(recensement_unique$Code_Site),recensement_unique$Code_poisson)
...
setwd(repertoire)
 setwd(input)
 requette.abondance.poissons<-read.csv2('abondance_taxo_IRD.csv')
  requette.abondance.poissons<-requette.abondance.poissons[!requette.abondance.poissons$site%in%suppressed.station,]
input.shannon.abondance<-xtabs(formula=requette.abondance.poissons$Abondance~as.character(requette.abondance.poissons$site)+requette.abondance.poissons$poissons,requette.abondance.poissons)
